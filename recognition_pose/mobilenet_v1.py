...
def mobilenet(widen_factor=1.0, num_classes=1000,input_channel=3):
    """
    Construct MobileNet.
    ...
    """
    model = MobileNet(widen_factor=widen_factor, num_classes=num_classes,input_channel=input_channel)
    return model
